...
namespace UITestsStudents
{
    public class UnitTest1
    {
        ...
        public async Task Test1Async()
        {
            ...
            combox_1.SelectedIndex = 3;
            combox_2.SelectedIndex = 1;
            combox_3.SelectedIndex = 2;
            combox_4.SelectedIndex = 3;
            combox_5.SelectedIndex = 2;
            button_add.Command.Execute(button_add.CommandParameter);

            await Task.Delay(50);
            textbox_text = textbox_s1.Text;
            string need_text = "1,67";
            Assert.True(textbox_text.Equals(need_text), " Average != '1,67'");

            textbox_text = textbox_s2.Text;
            need_text = "1";
            Assert.True(textbox_text.Equals(need_text), " Average != '1'");

            textbox_text = textbox_s3.Text;
            need_text = "1,33";
            Assert.True(textbox_text.Equals(need_text), " Average != '1,33'");

            textbox_text = textbox_s4.Text;
            need_text = "2";
            Assert.True(textbox_text.Equals(need_text), " Average != '2'");
            ...
            need_text = "1,47";
            Assert.True(textbox_text.Equals(need_text), " Average != '1,47'");
            ...
            textbox_text = textbox_s5.Text;
            need_text = "0";
            Assert.True(textbox_text.Equals(need_text), " Average != '0'");

            textbox_text = textbox_s6.Text;
            need_text = "1,4";
            Assert.True(textbox_text.Equals(need_text), " Average != '1.4'");
            ...
            textbox_text = textbox_s1.Text;
            need_text = "1,5";
            Assert.True(textbox_text.Equals(need_text), " Average != 1,5 ");
            ...
            textbox_text = textbox_s6.Text;
            need_text = "1,6";
            Assert.True(textbox_text.Equals(need_text), " Average != 1,6 ");
            ...
            Assert.True(textbox_color.Equals(need_color), " Error 1 button color != 'Green' ");

            textbox_color = (textbox_s5.Background as SolidColorBrush).Color;
            need_color = Colors.Red;
            Assert.True(textbox_color.Equals(need_color), " Error 1 button color != 'Red' ");
        }
    }
}